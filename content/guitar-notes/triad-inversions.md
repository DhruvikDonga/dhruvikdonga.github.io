...
## 2. Horizontal Formulas (Single-String Triads)

To map triads horizontally along any single string, start on your base note and count frets up the neck using these step-by-step interval distances:
...
## 3. Vertical Formulas (Across 3 Strings)

When mapping vertically across adjacent strings, your shapes depend directly on whether you cross standard **Perfect 4th** string sets or the **G-to-B string shift (Major 3rd tuning)**:
...
## 5. Lower 3 Strings (String Set 5-4-3: A–D–G)
...
| **1st Inversion** | Fret R+2 / R / R | Fret R+1 / R / R | Root note on **G string** (Fret R) |
...
## 6. Middle 3 Strings (String Set 4-3-2: D–G–B)
...
## 7. Top 3 Strings (String Set 3-2-1: G–B–e)

This set handles your primary vocal and melodic lead lines, making it effortless to play melody and harmony simultaneously.
...
## 8. Master Summary Table: All String Sets & Inversion Formulas

Use this master reference to instantly construct any Major or Minor triad across the three primary string groups:

<div class="table-responsive">

| String Set | Inversion Type | Major Shape Formula | Minor Shape Formula | Root Note Anchor (R) |
|:---|:---|:---|:---|:---|
...
| | **1st Inversion** | Fret R+2 / R / R | Fret R+1 / R / R | **G string** (Fret R) |
